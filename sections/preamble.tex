...
% REFERENCES
	...
	\makeglossaries
    \newglossaryentry{lgt}{name=LGT, description={Lateral gene transfer or horizontal gene transfer describes the movement of genetic material between organisms other than through vertical inheritance (parent to offspring)}}
	\newglossaryentry{OGT}{name=OGT, description={Optimal growth temperature is the optimal temperature at which an organism will grow}}
	\newglossaryentry{compositions}{name=composition, description={The composition of a proteome or genome describes the overall proportions of the 20 amino acids or five nucleotides within the sequence}}

	\newglossaryentry{crown group}{name=crown group, description={Organisms within the crown group are the living representatives of a group and their recent ancestors back to the most recent shared common ancestor}}
	\newglossaryentry{ribosomes}{name=ribosomes, description={The ribosome is an organelle responsible for protein manufacture by decoding the instructions in genomic material }}
	\newglossaryentry{proteome}{name=proteome, description={A proteome is the entire set of proteins expressed by an organism or genome}}
    \newglossaryentry{LUCA}{name=LUCA, description={The last universal common ancestor}}
    \newglossaryentry{LBCA}{name=LBCA, description={The last bacterial common ancestor}}
    \newglossaryentry{LACA}{name=LACA, description={The last archaeal common ancestor}}
